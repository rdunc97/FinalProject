...
//         <div className='p-4'>
//             <Back />
//             <h1 className='text-3x1 my-4'> Edit Game Entry </h1>
//             {loading ? <Load /> : ''}
//             <div className='flex flex-col border-4 border-yellow-500 rounded-x1 w-[600px] p-4 mx-auto'>
//                 <div className='my-4'>
...
//                     />
//                 </div>
//                 <button className='p-2 bg-green-300 m-8' onClick={handleEditGame} >
//                     Save Game
//                 </button>
//             </div>
//         </div>
...
return (
    <div className='p-6 bg-gray-100'>
        <Back />
        <h1 className='text-4xl font-bold text-gray-800 my-6'>Edit Game Entry</h1>
        {loading ? <Load /> : ''}
        <div className='flex flex-col border-4 border-yellow-600 rounded-lg shadow-lg p-6 bg-white max-w-lg mx-auto'>
            <div className='mb-4'>
            ...
            <button className='mt-4 w-full bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-green-600 focus:outline-none focus:shadow-outline' onClick={handleEditGame}>
                Save Game
            </button>
        </div>
    </div>
